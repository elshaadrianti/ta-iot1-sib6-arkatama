...
<body data-spy="scroll" data-target=".fixed-top">
                ...
                <div class="row">
                    <div class="col-lg-6">
                        <div class="text-container">
                            <h1><span class="turquoise">Easy Control </span> With IoT</h1>
                            <p class="p-large">Internet of Things (loT) is a concept where an object has the ability to transfer data over a network without requiring human-to-human or human-to-computer interaction.</p>
    ...
    <div class="copyright">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <p class="p-small"> elsaadrianty <a
                            href="">Politeknik Negeri Ujung Pandang</a></p>
                </div> <!-- end of col -->
            </div> <!-- enf of row -->
        </div> <!-- end of container -->
